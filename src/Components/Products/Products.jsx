...
const FilterSidebar = memo(({ filters, onFilterChange, onClearFilters }) => {
  const categories = [
    "ELECTRONICS",
    "FASHION",
    "HOME",
            ...
            <div className="text-center">
              ...
              <form onSubmit={handleSearch} className="max-w-2xl mx-auto">
                <div className="flex bg-white rounded-2xl overflow-hidden shadow-lg">
                  ...
                  <button
                    type="submit"
                    className="bg-emerald-600 text-white px-8 py-4 font-semibold hover:bg-emerald-700 transition flex items-center gap-2"
                  >
